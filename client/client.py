...
while running:
    ...
    if game_running:
        ...
        if is_paused and not pause_menu_active:
            # TODO: Since this is a multiplayer game, this should be placed
            #  in a new thread such that the entire game can run in the background

            pause_menu_active = True
            threading.Thread(target=pause_menu).start()
